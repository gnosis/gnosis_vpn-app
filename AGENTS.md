...
**Flags**: `src/assets/flags/` is generated by `scripts/generate-flags.py` and
committed -- country art from `flag-icons`, ISO 3166-2 subdivision art from
Wikimedia Commons. Re-run the script to refresh it; never hand-edit the output.
