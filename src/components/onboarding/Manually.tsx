...
import { isWxHOPRTransferred, isXDAITransferred, isPreparingSafe } from "@src/utils/status.ts";
  ...
  return (
    <div class="h-full w-full flex flex-col items-stretch p-6 gap-4">
      ...
      <div class="flex flex-col gap-4 grow">
        ...
        <FundingAddress address={isPreparingSafe(appState) ? appState.runMode.PreparingSafe.node_address : ""} />
