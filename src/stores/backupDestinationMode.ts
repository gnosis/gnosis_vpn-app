...
// back to `auto` (see docs/backup-destination-mode.md).
...
// rather than a live DOM/pixel measurement. See docs/backup-destination-mode.md.
...
export function createBackupDestinationMode(
  ...
  // docs/backup-destination-mode.md's promotion rule. Not part of the exposed
