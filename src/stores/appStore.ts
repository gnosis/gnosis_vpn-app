...
// TEMP(dev): durationMs shortened for interactive UI iteration — restore to
// 30_000 / 20_000 / 50_000 before merging.
const SYNC_PHASES = [
  { floor: 0, ceiling: 30, durationMs: 1_000 }, // DeployingSafe
  { floor: 30, ceiling: 50, durationMs: 1_000 }, // Warmup
  { floor: 50, ceiling: 100, durationMs: 1_000 }, // Channels/peers delay
] as const;
...
// TEMP(dev): shortened for interactive UI iteration — restore to 120 * 1000
// (2 minutes) before merging.
const MAXIMUM_DELAY_TIME = 5_000; // 5 seconds
let initialDelay:
